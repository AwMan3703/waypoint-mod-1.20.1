...
execute store result score @s ch_distanceX run scoreboard players get @s waypointX
execute store result score @s ch_distanceY run scoreboard players get @s waypointY
execute store result score @s ch_distanceZ run scoreboard players get @s waypointZ
